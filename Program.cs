...
Console.Clear();
Console.BackgroundColor = ConsoleColor.Blue;  //complete
...
Console.WriteLine("                            ");
Console.BackgroundColor = ConsoleColor.Red;  //complete
...
Console.WriteLine("      ");
Console.BackgroundColor = ConsoleColor.Black; //complete
